...
- For involvement at a governance level and to directly influence the direction:
    - Considering joining the [New Zealand Land-use Steering Group (NZLUSG)](https://nzlum.landcareresearch.co.nz/governance/nzlusg/), by emailing [landuse@landcareresearch.co.nz](mailto:landuse@landcareresearch.co.nz)
